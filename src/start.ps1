...
$jobBlock = {
    ...
    echo "You can then open http://$SRV_HOST`:$PORT/ in a Chromium or WebKit based browser"
    echo "to pick a device + page, or open http://$SRV_HOST`:$PORT/Main.html?ws=localhost:9222/devtools/page/1"
